...
- [ ] **Step 2-5:** implement; commit `feat(session): pending defender decisions — open/resolve/extend + eligible defenders`.
- [ ] **Apply the Execution Discipline block.**
...
- [ ] **Step 1-5:** failing test (an attack that exhausts the attacker's legal attacks auto-closes; one that leaves a legal attack stays open) → implement → commit `feat(session): attack-round auto-close on no-legal-attack`.
- [ ] **Apply the Execution Discipline block.**
...
- [ ] **Step 2-5:** implement; commit `feat(session): attack command — defender proposal, substitution, write-lock`.
- [ ] **Apply the Execution Discipline block.**
...
- [ ] **Step 1: Write failing tests** — an all-agent game driven purely by `driveOneStep` reaches a terminal state; an agent attacking a human seat opens a pending and halts the drive.
- [ ] **Step 2-5:** implement; commit `feat(session): agent attack rounds in driveOneStep`.
- [ ] **Apply the Execution Discipline block.**
...
- [ ] **Step 2-4:** run (expect green once A4.4 is correct); commit `test(session): reducer-drive equals recordGame for all-agent games`.
- [ ] **Apply the Execution Discipline block.**
...
- [ ] **Step 2-5:** implement; commit `feat(session): seat-claim CAS + token-digest (multi-tab)`.
- [ ] **Apply the Execution Discipline block.**
