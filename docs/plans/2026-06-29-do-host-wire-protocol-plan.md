...
| A4 — Pending decisions + write-lock | ✅ Shipped | cb8d5b90…a09f6e37 (13 commits incl. review fixes + pitfall doc) | branch `feat/session-pending-attack`; **PR pending — Review-class, Sam merges**; see Deviations (A4) + Discoveries (5 entries) |
