...
| B9 — DO/wire pitfalls documentation | ✅ Shipped | — | branch `feat/host-pitfalls` stacked on PR #52; Routine (docs only); 11 new entries (DO-*/WIRE-*), maintenance checklist complete |
